...
namespace Calculator
{
    public partial class fmCalculation : Form
    {
        ...
        private void RbPolares_CheckedChanged(object sender, EventArgs e)
            //Sets textbox on the other to false and to his true
        {
        ...
        private void btnCalculate_Click(object sender, EventArgs e)
        {
            ...
            if (RbPolares.Checked == true)
            {
                if (cb3DPolar.Checked != true)
                {
                    ...
                    {
                        MessageBox.Show("Only Numbers are accepted! Make sure the input isn't empty, or 0",
                            "Error Found!");
                    }
                }
                else
